...
class Question(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE)  # on_delete ~ : 계정이 삭제되면 작성한 질문도 모두 삭제됨
...
class Answer(models.Model):
    ...
    question = models.ForeignKey(Question,
                                 on_delete=models.CASCADE)  # ForeignKey는 다른 모델과 연결하며, on_delete~ 는 이 답변과 연결된 질문이 삭제되면 함께 삭제된다는 뜻
